...
package com.example.main_w.weekly.temp_model;
...
public class Item
{
    ...
    {
        return "ClassPojo [taMax8High = "+taMax8High+", taMin6Low = "+taMin6Low+", taMax8 = "+taMax8+", taMax7 = "+taMax7+", taMax9 = "+taMax9+", taMax9High = "+taMax9High+", taMax3Low = "+taMax3Low+", taMax7Low = "+taMax7Low+", taMin3Low = "+taMin3Low+", taMin7Low = "+taMin7Low+", taMax6High = "+taMax6High+", taMin9High = "+taMin9High+", taMax4 = "+taMax4+", taMax3 = "+taMax3+", taMax6 = "+taMax6+", taMax5 = "+taMax5+", taMax7High = "+taMax7High+", regId = "+regId+", taMax6Low = "+taMax6Low+", taMin8High = "+taMin8High+", taMin4 = "+taMin4+", taMin4Low = "+taMin4Low+", taMax9Low = "+taMax9Low+", taMin3 = "+taMin3+", taMin10 = "+taMin10+", taMin7High = "+taMin7High+", taMin8Low = "+taMin8Low+", taMin5High = "+taMin5High+", taMax10 = "+taMax10+", taMax5Low = "+taMax5Low+", taMin9 = "+taMin9+", taMin6 = "+taMin6+", taMin5 = "+taMin5+", taMin6High = "+taMin6High+", taMax5High = "+taMax5High+", taMin8 = "+taMin8+", taMin7 = "+taMin7+", taMin4High = "+taMin4High+", taMax10Low = "+taMax10Low+", taMin9Low = "+taMin9Low+", taMin5Low = "+taMin5Low+", taMin10Low = "+taMin10Low+", taMax4High = "+taMax4High+", taMin10High = "+taMin10High+", taMin3High = "+taMin3High+", taMax10High = "+taMax10High+", taMax4Low = "+taMax4Low+", taMax3High = "+taMax3High+", taMax8Low = "+taMax8Low+"]";
    }
}